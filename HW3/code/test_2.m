...
% distances(2:7) = isd;
% angles(2:7) = 30:60:360;
% 
% distances(8:13) = 2*isd*cosd(30);
% angles(8:13) = 0:60:300;
% 
% distances(14:19) = 2*isd;
% angles(14:19) = 30:60:360;
...
%     new_all_x = all_x + offsetX;
%     new_all_y = all_y + offsetY;
%     plot_circles_and_labels(radius, new_all_x, new_all_y);
% end
